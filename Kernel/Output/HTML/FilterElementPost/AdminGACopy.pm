...
package Kernel::Output::HTML::FilterElementPost::AdminGACopy;
...
sub __Linkify {
    my ($Self, $Baselink, $GAID, $Title, $Token ) = @_;

    my $Link = qq~
        | <a href="${Baselink}Action=AdminGACopy&ID=$GAID&ChallengeToken=$Token" title="$Title">
